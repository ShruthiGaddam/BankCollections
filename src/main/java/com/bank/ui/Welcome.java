...
import com.bank.userException.InsufficientBalanceException;
import com.bank.userException.InvalidMobileNoException;
		...
		while(j==1) {
	      ...
	      Scanner sc=new Scanner(System.in);
	    	...
	    	case 1://Registration
	    		...
	    		long mNo=account.setMobileNo(sc.nextLong());
	    	    		if(!transserv.validateMobile(mNo)) {
	    	    			try {
	    			...
	    			switch(ch2)
	    			 ...
	    			 case 1: //withdraw
	    				 	System.out.println("enter the amount to withdraw");
	 				 		int amt=sc.nextInt();
	 				 		if(!transserv.sufficientBalance(amt)) {
	 				 			try {
